...
%
\subsubsection*{Unit Headers vs.\ Node Headers}
...
\end{itemize}
%
\noindent\textbf{Note:} ``Explicit relation sentences'' refer only to author-written NL relation sentences, regardless of whether they restate edges already implied by indentation.
