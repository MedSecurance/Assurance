...
\section{Module declarations versus module references}

An important clarification now settled is the distinction between top-level module declarations and module occurrences within a local argument subtree.
...
The local module reference syntax has been changed to \texttt{ModuleRef} to match that of \texttt{GoalRef} and to relieve confusion that may have occured with module unit definitions. The previous form \texttt{Module} is still accepted for backward compatibility but new outlines should use \texttt{ModuleRef}.
