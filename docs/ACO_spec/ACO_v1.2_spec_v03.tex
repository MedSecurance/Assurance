...
The front-end provides a canonicalisation functionl that:
\begin{itemize}[leftmargin=2em]
...
An evidence category with provisional statusl may include (but is not limited to):
\begin{itemize}[leftmargin=2em]
...
\subsub\\section{\textcolor{blue}{Author Guidance Modes}}
