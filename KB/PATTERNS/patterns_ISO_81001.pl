...
ac_pattern('acceptable_risk',
		...
		goal(g1_1_1, 'G1.1.1: Acceptable risk - Residual risk of hazard {H} has been \c
			...
			[],
			[evidence('Hazard Log','Soln 1.1.1.1 - Hazard log identifies risk assessment',[])
			])).
...
ac_pattern('accepted_risk',
		...
		goal(g1_1_2, 'G1.1.2: Accepted risk - Clinical benefits outweigh residual risk \c
			...
			[],
			[evidence('Hazard Log','Soln 1.1.2.1 - Hazard log identifies risk assessment',[]),
			 evidence('Risk Acceptance','Authority accepts risk of hazard {H} in {HIT}',[])
			])).
